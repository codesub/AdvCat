...
def parse_args():
    ...
    parser.add_argument('--a', default='752', type=int, help='start of training')
    parser.add_argument('--b', default='790', type=int, help='end of training')
    ...
    parser.add_argument('--rand_k', default=100, type=int,
...
class Attacker(object):
    def __init__(self, best_parameters_file, opt):
        ...
        if opt.dataset == 'IPS':
            self.model = IPSRNN()
        elif opt.dataset == 'tiresias':
            self.model = Tiresias_DeepLog()
        else:
            self.model = None
...
def main():
    ...
    best_parameters_file = 'model_tiresias.pt'
